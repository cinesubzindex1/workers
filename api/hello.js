...
const serviceaccounts = [
  ...
  const authConfig = {
  "siteName": "csencorder", // Website name
  ...
  "refresh_token": "1//0ctmmnCj5EOsTCgYIARAAGAwSNwF-L9IrWpYEi_-yJ9svRww3Blr22XRfgkDuAHLSdN8aiaJkftc1rZzt_qUAV6yi-D6KKaAiMkE", // Authorize token
  ...
  "service_account_json": randomserviceaccount, // don't touch this one
      ...
      "roots":[
        { 
           ...
           "auth": {"kasun":"Kas@1995"} /* Remove double slash before "auth" to activate id password protection */
        },
        {
            "id": "0AJHMH9eiy5ciUk9PVA",
            "name": "S0",
            "protect_file_link": false,
           "auth": {"kasun":"Kas@1995", "userndddame1":"passwodddrd1"} /* Remove double slash before "auth" to activate id password protection */
        },
      ]};
    ...
    try {
      ...
      if (url.pathname === '/auth') {
        ...
        if (!authorizedResponse) {
          ...
          res.send('Unauthorized - Redirecting', { status: 302, headers: redirectHeaders })
